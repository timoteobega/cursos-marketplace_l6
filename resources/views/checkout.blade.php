            ...
            <div class="tab-pane fade show active" id="creditCard" role="tabpanel" aria-labelledby="creditCard-tab">
                ...
                <div class="col-md-6">
                    ...
                    <form action="" method="post">
                        ...
                        <button class="btn btn-success btn-lg processCheckout" data-payment="CREDITCART">Efetuar Pagamento</button>
                    </form>
                </div>
            ...
            <div class="tab-pane fade" id="boleto" role="tabpanel" aria-labelledby="boleto-tab">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button class="btn btn-success btn-lg processCheckout" data-payment="BOLETO">Pagar com Boleto</button>
                    </div>
                </div>
