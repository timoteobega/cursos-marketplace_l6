...
!(function (a, b) {
    ...
    var c = [],
        ...
        l = a.document,
        m =
            "2.1.1 -css,-css/addGetHookIf,-css/curCSS,-css/defaultDisplay,-css/hiddenVisibleSelectors,-css/support,-css/swap,-css/var/cssExpand,-css/var/getStyles,-css/var/isHidden,-css/var/rmargin,-css/var/rnumnonpx,-effects,-effects/Tween,-effects/animatedSelector,-dimensions,-offset,-deprecated,-event-alias,-wrap",
        n = function (a, b) {
    ...
    n.extend({
        find: function (a, b, c, d) {
            ...
            if (d) while ((e = d[g++])) n.find.matchesSelector(e, a) && c.push(e);
    ...
    (n.event = {
            ...
            if (
                ...
                while ((g = p[f++]) && !b.isPropagationStopped())
                    (b.type = f > 1 ? i : o.bindType || q),
                        (m = (O.get(g, "events") || {})[b.type] && O.get(g, "handle")),
                    m && m.apply(g, c),
                        (m = k && g[k]),
        ...
        (n.Event = function (a, b) {
            return this instanceof n.Event
                ? (a && a.type ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? $ : _)) : (this.type = a),
                b && n.extend(this, b),
    ...
    n.extend({
        clone: function (a, b, c) {
            ...
            if (!(k.noCloneChecked || (1 !== a.nodeType && 11 !== a.nodeType) || n.isXMLDoc(a))) for (g = pb(h), f = pb(a), d = 0, e = f.length; e > d; d++) qb(f[d], g[d]);
            if (b)
                if (c) for (f = f || pb(a), g = g || pb(h), d = 0, e = f.length; e > d; d++) ob(f[d], g[d]);
                else ob(a, h);
        ...
        n.fn.extend({
            ...
            domManip: function (a, b) {
                ...
                var c,
                    ...
                    p = a[0],
                    q = n.isFunction(p);
                if (q || (l > 1 && "string" == typeof p && !k.checkClone && fb.test(p)))
                ...
                if (l && ((c = n.buildFragment(a, this[0].ownerDocument, !1, this)), (d = c.firstChild), 1 === c.childNodes.length && (c = d), d)) {
                    ...
                    if (g)
                        for (i = f[f.length - 1].ownerDocument, n.map(f, mb), j = 0; g > j; j++)
        ...
        n.extend({
            attr: function (a, b, c) {
                var d,
                    ...
                    f = a.nodeType;
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return typeof a.getAttribute === V
                        ? n.prop(a, b, c)
                        : ((1 === f && n.isXMLDoc(a)) || ((b = b.toLowerCase()), (d = n.attrHooks[b] || (n.expr.match.bool.test(b) ? sb : rb))),
                            void 0 === c
        ...
        ajax: function (a, b) {
            ...
            if (
                ((o.promise(v).complete = p.add),
                    (v.success = v.done),
                    (v.error = v.fail),
                    (k.url = ((a || k.url || Ab) + "").replace(Bb, "").replace(Gb, zb[1] + "//")),
                    (k.type = b.method || b.type || k.method || k.type),
                    (k.dataTypes = n
                        .trim(k.dataType || "*")
                        .toLowerCase()
                        .match(H) || [""]),
                null == k.crossDomain && ((h = Hb.exec(k.url.toLowerCase())), (k.crossDomain = !(!h || (h[1] === zb[1] && h[2] === zb[2] && (h[3] || ("http:" === h[1] ? "80" : "443")) === (zb[3] || ("http:" === zb[1] ? "80" : "443")))))),
            ...
            i && 0 === n.active++ && n.event.trigger("ajaxStart"),
                ...
                (k.hasContent = !Fb.test(k.type)),
                (d = k.url),
            k.hasContent || (k.data && ((d = k.url += (yb.test(d) ? "&" : "?") + k.data), delete k.data), k.cache === !1 && (k.url = Cb.test(d) ? d.replace(Cb, "$1_=" + xb++) : d + (yb.test(d) ? "&" : "?") + "_=" + xb++)),
            ...
            ((k.data && k.hasContent && k.contentType !== !1) || b.contentType) && v.setRequestHeader("Content-Type", k.contentType),
                v.setRequestHeader("Accept", k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + Kb + "; q=0.01" : "") : k.accepts["*"]);
    ...
    function Wb(a, b, c, d) {
        ...
        else for (e in b) Wb(a + "[" + e + "]", b[e], c, d);
    }
                                ...
                                (delete Yb[g],
                                    ...
                                    "abort" === a
                                        ...
                                        : "error" === a
                                            ...
                                            : d(Zb[f.status] || f.status, f.statusText, "string" == typeof f.responseText ? { text: f.responseText } : void 0, f.getAllResponseHeaders()));
                            };
                        }),
                            (f.onload = b()),
                            (f.onerror = b("error")),
        ...
        n.ajaxPrefilter("json jsonp", function (b, c, d) {
            ...
            return h || "jsonp" === b.dataTypes[0]
                ? ((e = b.jsonpCallback = n.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback),
                    h ? (b[h] = b[h].replace(ac, "$1" + e)) : b.jsonp !== !1 && (b.url += (yb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e),
